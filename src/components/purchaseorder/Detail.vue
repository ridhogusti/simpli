<template>
  <div>
    <div id="printMe" style="border: 1px solid black; width: 24cm; height: 14cm;">
      <h3>PURCHASE ORDER
        <div style="float: right; font-family: LouisGeorgeCafe;">IRIAN SUPERMARKET</div>
      </h3>
      <br>
      <span>
      ...
      <table>
        ...
        <tbody v-for="(item, index) in itemsHeader.ListPurchaseOrderItem" :key="item.id">
          <tr>
            ...
            <td style="text-align: left">{{ item.Quantity }} {{ item.Unit.Name }}</td>
            ...
            <v-form ref="form">
              <div>
                      ...
                      <v-layout row wrap>
                        ...
                        <v-flex xs4>
                          <v-subheader class="label2">
                            : {{getSupplier(itemsHeader['SupplierId'],$store.state.supplier.suppliers).Company}}
                          </v-subheader>
                        </v-flex>
                        <v-flex xs3> </v-flex>
                      </v-layout>
                        ...
                        <v-flex xs8>
                          <v-layout row wrap>
                            ...
                            <v-flex xs4>
                              ...
                              <div class="text-xs-center label2">{{
                            ...
                            <v-flex xs3>
                              ...
                              <div class="text-xs-center label2">{{itemsHeader.DueDate}}</div>
                            </v-flex>
                          </v-layout>
                        </v-flex>
                        <v-flex xs2> </v-flex>
                ...
                <div>
                  ...
                  <v-card class="retangle1">
                    <v-card-text>
                      <v-data-table :headers="headers" :items="itemsHeader.ListPurchaseOrderItem" hide-actions class="elevation-1 tablePurchase">
                        <tr slot="items" slot-scope="props" style="background-color: !important">
                          ...
                          <td style="width: 300px !important; padding: 0px 10px !important;">
                            {{
                              filterDataBy(itemsHeader['ListPurchaseOrderItem'][props.index].ProductUnitId,productUnit).Name
                          ...
                          <td style="width: 170px !important; padding: 0px 10px !important">
                            {{itemsHeader['ListPurchaseOrderItem'][props.index].ProductDescription}}
                          </td>
                          <td style="width: 146px !important; padding: 0px 10px !important">
                            {{itemsHeader['ListPurchaseOrderItem'][props.index].ProductPrice}}
                          </td>
                          <td style="width: 146px !important; padding: 0px 10px !important" class="text-xs-right">
                            {{itemsHeader['ListPurchaseOrderItem'][props.index].Quantity}}
                          </td>
                          <td style="width: 146px !important; padding: 0px 10px !important;" class="text-xs-center">
                            <v-layout>
                              <v-flex xs7>
                                {{itemsHeader['ListPurchaseOrderItem'][props.index].DiscountPercentage}} %
                              </v-flex>
                            </v-layout>
                          </td>
                          <td style="padding: 10px 10px !important">
                            {{itemsHeader['ListPurchaseOrderItem'][props.index].Tax}}
                          </td>
                          <td class="text-xs-center" style="padding: 10px 10px !important">
                            <div class="subheading">
                              <!-- {{ formatPrice(lineTotal(props.index)) }} -->
                              {{ formatPrice(itemsHeader['ListPurchaseOrderItem'][props.index].LineTotal) }}
                            </div>
                          </td>
