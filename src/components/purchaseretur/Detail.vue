...
import { GET_STATE_PURCHASES_RETUR, GET_PURCHASE_RETUR } from '../../store/actions.type'
...
export default {
  ...
  computed: {
    itemsHeader () {
      return this.$store.state.purchaseretur.purchaseretur
    },
    items () {
      return this.$store.state.purchaseretur.purchaseretur.ListPurchaseItem
    },
    pages () {
