...
import { CREATE_EMPLOYEEITEMSHIFT } from '@/store/actions.type'
...
export default {
  ...
  data () {
    return {
      title: 'Create a New EmployeeItemShift',
      alert: {
  ...
  methods: {
    ...
    save () {
      if (this.$refs.form.validate()) {
        ...
        this.$store.dispatch(CREATE_EMPLOYEEITEMSHIFT, this.employeeitemshift)
        .then((response) => {
          this.alert = {
            status: true,
            type: 'success',
